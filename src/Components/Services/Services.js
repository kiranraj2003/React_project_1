      ...
      <section className="bg-light py-5 py-xl-8">
        ...
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-xl-0">
            <div className="col-12 col-sm-6 col-xl-3 box_con">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4"> After-Sales Support</h4>
                  <p className="mb-4 text-secondary">
                    Highlight services like warranty assistance, repairs,
                    software updates, and easy replacement policies to ensure
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Wide Range of Products</h4>
                  <p className="mb-4 text-secondary">
                    Showcase the availability of the latest smartphones,
                    accessories, and gadgets from top brands to meet diverse
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Personalized Assistance</h4>
                  <p className="mb-4 text-secondary">
                    Offer guidance on product selection
                    based on customer needs, along with live chat, email, and
                    in-store consultation support.
                  </p>
                  <Link
                    href="#!"
                    className="fw-bold text-decoration-none link-primary"
            ...
            <div className="col-12 col-sm-6 col-xl-3">
              <div className="card border-0 border-bottom border-primary shadow-sm">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <p className="mb-4 text-secondary">
                    We offer 24/7 support to our clients. This means that you
                    can always get help when you need it, no matter what time it
                    is.
                  </p>
                  <Link
                    href="#!"
